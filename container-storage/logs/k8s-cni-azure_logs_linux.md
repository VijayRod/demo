```
filev=$(hostname)-azurevnet-$(date -u +%Y%m%d%H%M%S)Z # or filev=azurevnet.out
...
ls -l /tmp/*azurevnet*
# cat /tmp/$filev
# /tmp/aks-nodepool1-17884086-vmss000000-azurevnet-20231006192235Z # or /tmp/azurevnet.out
