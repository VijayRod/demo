...
# acstor within a node pool
az aks nodepool add -g $rg --cluster-name aks -n np4 --mode user -s Standard_D8s_v3 # Standard_E8ds_v5
kubectl get no
az aks update -g $rg -n aks --enable-azure-container-storage ephemeralDisk --azure-container-storage-nodepools np4
az aks get-credentials -g $rg -n aks --overwrite-existing
kubectl get po -n acstor -owide; k get sc
```
